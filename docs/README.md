...
- [tests-evidence.md](test-evidence.md) — Evidencia de ejecución de tests automáticos.
- [video.md](video.mdd) — Link al video explicativo y guion.
- [installation-instructions.md](installation-instructions.md) - Instrucciones de instalación
